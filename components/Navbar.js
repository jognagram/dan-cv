            ...
            <nav className = "fixed z-20 bg-white w-full">
                <div className = "w-full">
                    <div className="flex items-center h-20 w-full">
                        <div className="flex items-center sm:smx-10 md:mx-20 justify-between w-full">
                            <div className="flex justify-center items-center flex-shrink-0">
                                <h1 className=" font-bold text-x1 cursor-pointer">
                                    Fored<span className="text-blue-500">Line</span>
                                </h1>
                            </div>

                            <div className="hidden md:block">
                                <div className="ml-m10 flex items-baseline space-x-4">
                            ...
                            <div className="flex justify-center items-center flex-shrink-0">
                                <h1 className=" font-semibold text-lg cursor-pointer hidden md:block">
                                    Say <span className="text-blue-500">hi Dan</span>
                                </h1>
                            </div>
                        </div>
                ...
                <Transition
                    ...
                    leaveTo="opacity-0 scale-950"
                    >
                        {(ref) => (
                            <div className="md:hidden" id="mobile-menu">
                                <div
                                    ref={ref}
                                    className="bg-white mx-4 mr-20 pt-4 space-y-1"
                                    >
                                    <Link
									href="/home"
									activeClass="home"
                                ...
                                <Link
									...
									className="cursor-pointer hover:bg-blue-600 text-black hover:text-white block px-3 py-2 rounded-md text-base font-medium"
								>
									Say<span className="text-black">hi Dan</span>
								</Link>
                                </div>
                            </div>
                        )}
